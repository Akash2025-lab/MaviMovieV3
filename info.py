...
auth_channel = environ.get('AUTH_CHANNEL', '-1002352149702') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001934056027')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002460755631')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ppfan876:twgzmUQd8QtBRtNv@cluster0.jzxue.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+3Ej3eUYX9Gs3NTg1')
